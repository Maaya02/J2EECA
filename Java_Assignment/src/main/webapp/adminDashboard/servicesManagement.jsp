...
<body>
	<div class="sidebar close">
		<ul class="nav-links">
			...
			<li><a href="servicesManagement.jsp"
				style="background-color: #557788;"> <i
						...
						<div class="modal-dialog">
							<div class="modal-content">
											...
											<div
												...
												<div class="select-wrapper">
													<select class="form-select category-select"
														...
														<option value="smart-help">Smart Help</option>
												...
												<div class="input-mode d-none">
													<div class="input-group">
														<input type="text" class="form-control new-category-input"
															...
															class="input-group-text confirm-btn" role="button">
								...
								<div class="modal-footer">
									...
									<button type="submit" class="btn btn-primary" disabled id="saveChanges">Save
										changes</button>
								</div>
																	</form>
					...
					<tbody>
						...
						try {
							...
							categoryTag = "Nil";
								...
								out.println("<td><a href='deleteServices.jsp?id=" + id + "'><i class='bx bx-trash'></i></a></td>");
								out.println("</tr>");
							}
							conn.close();
						} catch (Exception e) {
